...
6. Sometimes you will get an error `DELETE_FAILED` in this case you will have to go into `Events` and check why it failed to delete . 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTEwNzQ4MDYwNTcsLTE4NjM5NzQ5ODcsMT
